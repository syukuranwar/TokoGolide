...
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/bg_1.jpg'); ?>');">
  ...
  <section class="ftco-section contact-section bg-light">
    <div class="container">
        ...
        <div class="col-md-3 d-flex">
            <div class="info bg-white p-4">
              <p><span>Website</span> www.TokoGolide.com</p>
            </div>
        </div>
      </div>
      <div class="row block-9">
        ...
        <div class="col-md-6 d-flex">
            <div style="width: 100%">
             <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126741.36677156623!2d107.5612306568352!3d-6.9302621222116665!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68c2bdab5b9dd5%3A0x813c637cc06fa03e!2sRIUNG%20BANDUNG!5e0!3m2!1sid!2sid!4v1665503611289!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
      </div>
    </div>
