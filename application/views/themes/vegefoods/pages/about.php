          ...
          <div class="container">
              <div class="row">
                  <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(<?php echo get_theme_uri('images/aboutt.jpg'); ?>);">
                      <a href="https://www.youtube.com/hBy7OzZ8e8M" class="icon popup-vimeo d-flex justify-content-center align-items-center">
...
<section class="ftco-section">
    ...
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          <h3 class="heading">KUALITAS DAN BAHAN TERBAIK</h3>
          <span>AMBIL LANGSUNG TERBAIK DARI GROSIR</span>
        </div>
      </div>    
    </div>
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          ...
          <span>KUALITAS DARI BAHAN DAN KUALITAS TERBAIK</span>
        </div>
      </div>      
    </div>
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
