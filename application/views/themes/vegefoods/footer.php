    ...
    <div class="container">
      ...
      <div class="row mb-5">
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            <h2 class="ftco-heading-2"style="color: #f3f3f3"><?php echo get_store_name(); ?></h2>
            <p><?php echo get_settings('store_description'); ?></p>
            <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
              <li class="ftco-animate"><a href="https://twitter.com/login" target="_blank"><span class="icon-twitter"></span></a></li>
              <li class="ftco-animate"><a href="https://web.facebook.com/?_rdc=1&_rdr" target="_blank"><span class="icon-facebook" ></span></a></li>
              <li class="ftco-animate"><a href="https://www.instagram.com/stories/highlights/17879254663547929/?hl=id" target="_blank"><span class="icon-instagram"></span></a></li>
            </ul>
          </div>
        </div>
        <div class="col-md">
          <div class="ftco-footer-widget mb-4 ml-md-5">
            <h2 class="ftco-heading-2" style="color: #f3f3f3">Menu</h2>
            <ul class="list-unstyled">
              <li><a href="<?php echo site_url('pages/about'); ?>" style="color: #f3f3f3" class="py-2 d-block">Tentang Kami</a></li>
        ...
        <div class="col-md-4">
           <div class="ftco-footer-widget mb-4">
            <h2 class="ftco-heading-2" style="color: #f3f3f3">Bantuan</h2>
            <div class="d-flex">
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2" style="color: #f3f3f3">Punya Pertanyaan?</h2>
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <p>
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | TOKO GOLIDE<i class="icon-heart text-danger" aria-hidden="true"></i> for every people.
