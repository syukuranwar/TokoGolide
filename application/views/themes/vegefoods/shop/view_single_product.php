...
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/bg_1.jpg'); ?>');">
  ...
  <section class="ftco-section">
    <div class="container">
      ...
      <div class="dropdown  btn btn-black mt-2 ml-1  ">
        <button class="btn btn-secondary dropdown-toggle " type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: #fff;">
          <label for="pree mt-2 ml-1">Pree-Order :</label>
          <select id="pree" name="preorder" onchange="myFunction()">
