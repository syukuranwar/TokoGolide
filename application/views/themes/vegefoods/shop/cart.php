                          ...
                          <tbody>
                            ...
                            <tr class="text-center cart-<?php echo $item['rowid']; ?>" >
                              ...
                              <td class="product-name">
                                  <h3 style="color: #f3f3f3"><?php echo $item['name']; ?></h3>
                              </td>
                              
                              <td class="price" style="color: #f3f3f3">Rp <?php echo format_rupiah($item['price']); ?></td>
          ...
          <div class="row justify-content-end">
              <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                  <div class="cart-total mb-3">
                      <h3 style="color: #f3f3f3">Kode Kupon</h3>
                      <p style="color: #f3f3f3">Punya kode kupon? Gunakan kupon kamu untuk mendapatkan potongan harga menarik</p>
                        
                <div class="form-group">
                    <label for="code"style="color: #f3f3f3">Kode:</label>
              ...
              <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                  <div class="cart-total mb-3">
                      <h3 style="color: #f3f3f3">Rincian Keranjang</h3>
                      <p class="d-flex">
                          <span style="color: #f3f3f3">Subtotal</span>
                          <span class="n-subtotal font-weight-bold" style="color: #f3f3f3">Rp <?php echo format_rupiah($total_cart); ?></span>
                      </p>
                      <p class="d-flex">
                          <span style="color: #f3f3f3">Biaya pengiriman</span>
                          <?php if ( $total_cart >= get_settings('min_shop_to_free_shipping_cost')) : ?>
                          <span class="n-ongkir font-weight-bold">Gratis</span>
                          <?php else : ?>
                            <span class="n-ongkir font-weight-bold" style="color: #f3f3f3">Rp <?php echo format_rupiah(get_settings('shipping_cost')); ?></span>
                          <?php endif; ?>
                      </p>
